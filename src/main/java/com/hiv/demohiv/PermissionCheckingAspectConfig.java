...
//@ConditionalOnMissingBean(PermissionCheckingAspectConfig.class)
//@ConditionalOnProperty(prefix = "sbp.security", name = "enabled", havingValue = "true")
//public class PermissionCheckingAspectConfig {
//
//    @Bean
//    public PermissionCheckingAspectConfig permissionCheckingAspect() {
//        return new PermissionCheckingAspectConfig();
//    }
//
//}
